...
# msft = yf.Ticker("^SPX")
msft = yf.Ticker("PSP5.PA")

# yes ! 30min lag ou veille si marché fermé
historical_prices = msft.history(period="1d", interval="1m")
...
# print(f'current {infos.currentPrice}')
print(infos['open'])
print(infos['previousClose'])
print(infos['dayLow'])
print(infos['dayHigh'])
...
# >>> data = yf.download("^SPX", start="2024-09-10", end="2024-09-11")
# [*********************100%***********************]  1 of 1 completed
# >>> data
#                    Open         High          Low       Close   Adj Close      Volume
# Date
# 2024-09-10  5490.509766  5497.910156  5441.720215  5495.52002  5495.52002  3848180000


{'maxAge': 86400, 'priceHint': 2, 'previousClose': 94.785, 'open': 94.77, 'dayLow': 94.46, 'dayHigh': 94.96, 'regularMarketPreviousClose': 94.785, 'regularMarketOpen': 94.77, 'regularMarketDayLow': 94.46, 'regularMarketDayHigh': 94.96, 'trailingPE': 0.39233658, 'volume': 184, 'regularMarketVolume': 184, 'averageVolume': 4414, 'averageVolume10days': 2867, 'averageDailyVolume10Day': 2867, 'bid': 94.42, 'ask': 94.57, 'totalAssets': 108804184, 'fiftyTwoWeekLow': 46.1, 'fiftyTwoWeekHigh': 108.15, 'fiftyDayAverage': 98.4388, 'twoHundredDayAverage': 85.50213, 'navPrice': 94.25188, 'currency': 'USD', 'ytdReturn': 0.32836878, 'fundFamily': 'WisdomTree Multi Asset Issuer PLC', 'fundInceptionDate': 1355356800, 'legalType': 'Exchange Traded Fund', 'threeYearAverageReturn': 0.040292602, 'fiveYearAverageReturn': 0.2123986, 'exchange': 'LSE', 'quoteType': 'ETF', 'symbol': '3USL.L', 'underlyingSymbol': '3USL.L', 'shortName': 'WISDOMTREE MULTI ASSET ISSUER P', 'longName': 'WisdomTree S&P 500 3x Daily Leveraged', 'firstTradeDateEpochUtc': 1355385600, 'timeZoneFullName': 'Europe/London', 'timeZoneShortName': 'BST', 'uuid': '0bb00a61-0454-356b-8cdf-50387b589a48', 'messageBoardId': 'finmb_237801722', 'gmtOffSetMilliseconds': 3600000, 'trailingPegRatio': None}
